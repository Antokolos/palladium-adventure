...
func _ready():
	if Engine.editor_hint:
		return
	__PLDRT.game_state.register_activatable(self)

func get_activatable_id():
	return activatable_id

func get_activatable_state():
	return __PLDRT.game_state.get_activatable_state(get_path())
...
func change_state(new_state):
	var path = get_path()
	var previous_state = __PLDRT.game_state.get_activatable_state(path)
	__PLDRT.game_state.set_activatable_state(get_path(), new_state)
